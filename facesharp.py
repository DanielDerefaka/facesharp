...
print
print 'Github : https://github.com/DanielDerefaka'
print
...
passwordlist = str(raw_input("Guys Enter the wordlist name and path : "))
...
def main():
	...
	welcome()
	search()
	print("Hey Password does not exist in the wordlist")
